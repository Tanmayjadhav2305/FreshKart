        ...
        <div className="min-h-[calc(100vh-80px)] flex">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 bg-white dark:bg-gray-900 transition-colors duration-300">
                <div className="mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Join FreshKart for premium quality groceries</p>
                </div>
            ...
            <div className="hidden md:block w-1/2 bg-gray-50 dark:bg-gray-800 relative overflow-hidden transition-colors duration-300">
                <img
                    src="https://images.unsplash.com/photo-1608686207856-001b95cf60ca?auto=format&fit=crop&q=80&w=1000"
                    alt="Fresh Fruits"
                    className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-12">
                    <blockquote className="text-white">
                        <p className="text-2xl font-serif italic mb-4">"Freshness isn't just a promise, it's our guarantee. Delivered to your doorstep."</p>
                    </blockquote>
                </div>
            </div>
        </div>
